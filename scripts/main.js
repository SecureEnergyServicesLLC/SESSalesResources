...
const DEFAULT_WIDGETS = [
    ...
    { id: 'lmp-geo-map', name: 'LMP Geographic Explorer', version: '1.0', updated: '2026-02-07', icon: '<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="10" r="3"/><path d="M12 21.7C17.3 17 20 13 20 10a8 8 0 1 0-16 0c0 3 2.7 7 8 11.7z"/></svg>', src: 'widgets/lmp-geo-map.html', fullWidth: true, defaultHeight: 800, minHeight: 500, maxHeight: 1200 },
...
function getWidgetLabel(widget) {
    const labels = {
        ...
        'lmp-geo-map': 'LMP Geographic Explorer',
...
window.createUser = async function() {
    ...
    const permissions = {
        ...
        'lmp-geo-map': document.getElementById('perm-lmp-geo-map')?.checked ?? true,
...
window.editUser = function(userId) {
    ...
    content.innerHTML = '<div class="edit-user-form">' +
        ...
        '<div class="widget-permission-item"><span>LMP Geographic Explorer</span><label class="toggle-switch"><input type="checkbox" id="edit-perm-lmp-geo-map" ' + getChecked('lmp-geo-map') + '><span class="toggle-slider"></span></label></div>' +
...
window.saveUserEdit = async function(userId) {
    ...
    const updates = {
        ...
        permissions: {
            ...
            'lmp-geo-map': document.getElementById('edit-perm-lmp-geo-map')?.checked,
